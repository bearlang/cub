...
backend-test: $(MAIN_SRCS) backend.c test/backend-test.c
	gcc $(CFLAGS) $(MAIN_SRCS) backend.c test/backend-test.c -o test/$@ 2>&1
llvm-backend-test: $(MAIN_SRCS) llvm-backend.c test/backend-test.c
	gcc $(CFLAGS) $(MAIN_SRCS) llvm-backend.c test/backend-test.c -o test/$@ 2>&1
clean:
